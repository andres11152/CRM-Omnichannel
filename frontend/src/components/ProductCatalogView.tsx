          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={i}
                  className="h-96 bg-white dark:bg-reply-surface-dark rounded-[2.5rem] border border-gray-100 dark:border-reply-border-dark animate-pulse"
                />
              ))}
            </div>
          ) : filteredProducts.length === 0 ? (
            <div className="text-center py-24 bg-white dark:bg-reply-surface-dark rounded-[3rem] border border-dashed border-gray-200 dark:border-reply-border-dark shadow-inner">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-10">
              {filteredProducts.map((product: Product) => (
                <div
                  key={product.id}
                  className="group bg-white dark:bg-reply-surface-dark rounded-[2.5rem] border border-gray-100 dark:border-reply-border-dark shadow-xl shadow-gray-200/50 dark:shadow-none overflow-hidden transition-all hover:scale-[1.02] hover:shadow-2xl flex flex-col"
                >
                  {/* Image Section */}
                  <div className="relative h-64 bg-reply-bg dark:bg-gray-900 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 flex gap-2">
                      <span className="px-3 py-1 bg-white/90 dark:bg-reply-surface-dark/90 backdrop-blur-md rounded-full text-[10px] font-black uppercase tracking-widest text-emerald-600 shadow-sm border border-emerald-100/20">
                        {product.category}
                      </span>
                    </div>
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="bg-reply-bg dark:bg-gray-800/50 p-3 rounded-2xl border border-gray-100 dark:border-reply-border-dark">
