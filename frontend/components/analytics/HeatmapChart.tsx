...
export const HeatmapChart: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className="h-80 w-full bg-white dark:bg-[#111b21] rounded-xl p-4 border border-gray-100 dark:border-gray-800">
          ...
          <Tooltip
            ...
            content={({ active, payload }) => {
              if (active && payload && payload.length) {
                ...
                return (
                  <div className="bg-white dark:bg-gray-800 p-2 border border-gray-200 dark:border-gray-700 shadow-lg rounded text-xs">
