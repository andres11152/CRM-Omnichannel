      ...
      <div className="bg-white dark:bg-reply-panel-dark w-full max-w-md rounded-xl shadow-2xl flex flex-col max-h-[80vh]">
        ...
        <div className="p-4">
          <input
            ...
            className="w-full bg-gray-100 dark:bg-reply-surface-dark border border-transparent focus:border-reply-green rounded-lg px-4 py-2 text-sm text-gray-800 dark:text-white focus:outline-none"
          />
        </div>
          ...
          {loading ? (
            ...
            filteredAgents.length === 0 ? (
              ...
              filteredAgents.map((agent) => (
                <div
                  ...
                  className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer border ${selectedId === agent.id ? "border-reply-green bg-reply-green/10 dark:bg-reply-green-dark/10" : "border-transparent hover:bg-reply-bg dark:hover:bg-gray-800"}`}
                >
            ...
            filteredQueues.map((queue) => (
              <div
                ...
                className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer border ${selectedId === queue.id ? "border-reply-green bg-reply-green/10 dark:bg-reply-green-dark/10" : "border-transparent hover:bg-reply-bg dark:hover:bg-gray-800"}`}
              >
