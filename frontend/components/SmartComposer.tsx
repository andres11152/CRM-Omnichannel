...
export const SmartComposer: React.FC<SmartComposerProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-[#202c33] px-4 py-3 flex flex-col gap-3 border-t border-gray-200 dark:border-gray-700 transition-colors duration-200">
      
      {/* âœ… Attachment Preview */}
      {selectedFile && (
        <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-[#111b21] rounded-lg border border-indigo-100 dark:border-indigo-900/30 relative animate-fade-in mx-2">
      ...
      <div className="flex items-center gap-2 px-2">
        ...
        <div className="relative">
          ...
          {showAIMenu && (
            <div className="absolute bottom-full left-0 mb-2 w-56 bg-white dark:bg-[#202c33] rounded-xl shadow-2xl border-2 border-gray-200 dark:border-gray-700 overflow-hidden z-50">
      ...
      {/* Input Area */}
      <div className="flex items-end gap-3 rounded-2xl bg-gray-50 dark:bg-[#111b21] border border-gray-200 dark:border-gray-700 p-2 shadow-sm transition-all focus-within:ring-2 focus-within:ring-indigo-500 dark:focus-within:ring-indigo-400 focus-within:border-transparent">
