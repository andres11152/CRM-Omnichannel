...
export const ContactTimelineView: React.FC<Props> = ({
  ...
  return createPortal(
    ...
    >
      <div
        className="w-full max-w-md bg-white dark:bg-reply-panel-dark h-full shadow-2xl flex flex-col animate-slide-in-right transform transition-transform"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="h-16 flex items-center justify-between px-6 border-b border-gray-100 dark:border-reply-border-dark bg-white dark:bg-reply-panel-dark">
          <div>
        ...
        <div className="flex-1 overflow-y-auto p-6 scrollbar-thin">
          {loading ? (
            ...
            <div className="relative border-l-2 border-gray-200 dark:border-reply-border-dark ml-3 space-y-8 pb-8">
              {timeline.map((event, index) => (
                ...
                >
                  {/* Icon */}
                  <div
                    className={`absolute -left-[11px] top-0 w-6 h-6 rounded-full border-2 border-white dark:border-[#202c33] flex items-center justify-center text-xs shadow-sm bg-white dark:bg-reply-surface-dark
                  ...
                  {/* Content Card */}
                  <div className="bg-reply-bg dark:bg-gray-800/50 p-4 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors border border-transparent hover:border-gray-200 dark:hover:border-gray-600">
