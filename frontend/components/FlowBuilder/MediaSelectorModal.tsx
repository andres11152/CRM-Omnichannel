...
export const MediaSelectorModal: React.FC<MediaSelectorModalProps> = ({ type, onSelect, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[99999] p-4 animate-fadeIn">
      <div className="bg-white dark:bg-[#202c33] rounded-xl max-w-4xl w-full max-h-[85vh] overflow-hidden flex flex-col shadow-2xl animate-slideUp">
        {/* Header */}
        <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-[#111b21] dark:to-[#202c33]">
        ...
        {/* Footer */}
        <div className="p-6 border-t border-gray-200 dark:border-gray-700 flex justify-end items-center bg-gray-50 dark:bg-[#111b21] gap-3">
          <button
            onClick={onClose}
