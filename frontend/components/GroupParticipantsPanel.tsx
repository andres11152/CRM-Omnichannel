...
export const GroupParticipantsPanel: React.FC<Props> = ({
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-[#0f1419] border-l border-gray-200 dark:border-gray-800 w-80 shadow-xl z-20">
      {/* Header */}
      <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-[#1a202c]">
        <div>
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1">
        {data.participants.map((p) => (
          <div
            key={p.jid}
            className="group flex justify-between items-center p-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-[#1a202c] border border-transparent hover:border-gray-200 dark:hover:border-gray-700 transition-all"
          >
