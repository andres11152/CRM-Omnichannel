          ...
          <>
            ...
            <div>
              ...
              {(node.data.mediaUrl || node.data.imageUrl) && (
                <div className="mb-2 p-2 bg-gray-50 dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-700 flex items-center justify-between">
              ...
              <div className="mb-4 animate-fadeIn">
                ...
                {loadingRouting ? (
                  ...
                  <select
                    ...
                    className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm outline-none focus:ring-2 focus:ring-pink-500"
                  >
