...
export const AgentPerformanceTable: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#111b21] rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm">
          <thead className="bg-gray-50/50 dark:bg-[#202c33] text-gray-500 dark:text-gray-400 font-medium">
            <tr>
              <th
