...
export const LoginScreen: React.FC<Props> = ({
  ...
  return (
    <div className="flex min-h-screen bg-reply-bg dark:bg-[#0b141a] font-sans transition-colors duration-300">
      {/* LEFT SIDE: BRANDING */}
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-[#00a884] dark:bg-[#005c4b] items-center justify-center">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="mb-8">
            <a
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm bg-white dark:bg-[#202c33] text-sm font-semibold text-gray-700 dark:text-white hover:bg-gray-50 dark:hover:bg-[#2a3942] transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-gray-200"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#f0f2f5] dark:bg-[#0b141a] text-gray-500 font-medium">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="block w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#202c33] text-gray-900 dark:text-white shadow-sm focus:ring-2 focus:ring-reply-green focus:border-transparent transition-all placeholder-gray-400 dark:placeholder-gray-500"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="block w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#202c33] text-gray-900 dark:text-white shadow-sm focus:ring-2 focus:ring-reply-green focus:border-transparent transition-all placeholder-gray-400 dark:placeholder-gray-500 pr-12"
                  placeholder="••••••••"
                />
                <button
                  type="button"
      ...
      {blockedStatus && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
          <div className="bg-white dark:bg-[#202c33] rounded-2xl shadow-2xl max-w-md w-full overflow-hidden border border-red-200 dark:border-red-900/50 scale-100">
            ...
            <div className="p-6 space-y-4">
              <div className="bg-gray-50 dark:bg-[#111b21] p-4 rounded-lg">
