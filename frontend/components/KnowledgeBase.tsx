...
export const KnowledgeBase: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-[#202c33] rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 transition-colors duration-200">
      <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#2a3942]">
      ...
      <div className="p-6 flex-1 overflow-y-auto custom-scrollbar">
        {/* Upload Area */}
        <div
          className={`border-2 border-dashed rounded-xl p-8 text-center transition-all mb-8 ${dragActive ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-900/30" : "border-gray-300 dark:border-gray-600 hover:border-gray-400 bg-gray-50 dark:bg-[#111b21]"}`}
        ...
        {isLoading ? (
          ...
          <div className="space-y-3">
            {documents.length === 0 && (
              <div className="text-center py-10 text-gray-400 italic bg-gray-50 dark:bg-[#111b21] rounded-lg border border-dashed border-gray-300 dark:border-gray-700">
            ...
            {documents.map((doc) => (
              <div
                key={doc.id}
                className="flex items-center justify-between p-4 bg-white dark:bg-[#202c33] border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-all hover:border-indigo-200 dark:hover:border-indigo-800"
              >
