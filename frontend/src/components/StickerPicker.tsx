...
export const StickerPicker: React.FC<StickerPickerProps> = ({
  ...
  return (
    <div className="absolute bottom-full left-0 mb-3 ml-2 w-[calc(100vw-24px)] xs:w-[320px] sm:w-[350px] h-[60vh] xs:h-[400px] sm:h-[450px] bg-white/95 dark:bg-reply-panel-dark/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200 dark:border-reply-border-dark flex flex-col z-50 overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-2 duration-200 origin-bottom-left">
      {/* Premium Header Tabs */}
      <div className="flex items-center gap-1.5 p-1.5 sm:p-2 bg-reply-bg/50 dark:bg-reply-surface-dark/50 border-b border-gray-100 dark:border-reply-border-dark">
      ...
      <div className="flex-1 overflow-hidden relative">
        {activeTab === "emoji" ? (
          ...
          <div className="flex flex-col h-full bg-reply-bg dark:bg-reply-bg-dark">
            {/* Sticker Search Bar */}
            <div className="p-2 sm:p-3 bg-white dark:bg-reply-panel-dark border-b border-gray-100 dark:border-reply-border-dark">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 bg-gray-100 dark:bg-reply-surface-dark rounded-xl text-sm text-gray-800 dark:text-white border-none focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all placeholder:text-gray-400"
                />
              </div>
            </div>
