                        ...
                        <button
                          ...
                          className={`flex items-center justify-center gap-3 py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all ${
                            selectedChannel === "WHATSAPP"
                              ...
                              : "bg-reply-bg dark:bg-gray-900 text-gray-500 border border-gray-100 dark:border-reply-border-dark hover:bg-gray-100"
                          }`}
                        >
                        ...
                        <button
                          ...
                          className={`py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all ${
                            scheduleMode === "now"
                              ...
                              : "bg-white dark:bg-gray-800 text-gray-500 border border-gray-100 dark:border-reply-border-dark"
                          }`}
                        >
                          Lanzar Ahora
                        </button>
                      ...
                      {scheduleMode === "later" && (
                        <div className="animate-fade-in-down">
                          ...
                          <input
                            ...
                            className="w-full bg-white dark:bg-gray-900 border border-gray-100 dark:border-reply-border-dark rounded-2xl px-6 py-4 focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 transition-all outline-none font-medium text-gray-900 dark:text-white"
                          />
                        </div>
                      )}
                    </div>
              ...
              <div className="p-8 border-t border-gray-100 dark:border-reply-border-dark bg-reply-bg/50 dark:bg-gray-800/10 flex justify-between">
                {builderStep > 1 ? (
                  <button
                    ...
                    className="px-8 py-4 rounded-[1.25rem] border border-gray-100 dark:border-reply-border-dark font-black text-[10px] uppercase tracking-widest text-gray-500 hover:bg-gray-100 transition-all active:scale-95"
                  >
                    Regresar
                  </button>
                ) : (
          ...
          <div className="fixed inset-0 z-[100] bg-reply-bg dark:bg-reply-bg-dark flex flex-col animate-fade-in font-sans">
            ...
            <div className="h-16 px-6 bg-white dark:bg-reply-panel-dark border-b border-gray-200 dark:border-reply-border-dark flex justify-between items-center shadow-sm z-30 relative">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Device Toggles */}
                <div className="flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1 border border-gray-200 dark:border-reply-border-dark">
                  <button
                ...
                <button
                  ...
                  className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-bold text-gray-700 dark:text-gray-300 hover:bg-reply-bg dark:hover:bg-gray-800 transition-colors"
                >
                  Enviar Test
                </button>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm bg-reply-bg dark:bg-reply-surface-dark dark:text-white focus:ring-2 ring-indigo-500 outline-none"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm bg-reply-bg dark:bg-reply-surface-dark dark:text-white h-20 resize-none focus:ring-2 ring-indigo-500 outline-none"
            ...
            <div className="flex-1 flex overflow-hidden">
              ...
              <div className="w-[420px] flex flex-col border-r border-gray-200 dark:border-reply-border-dark bg-white dark:bg-reply-surface-dark z-20 shadow-lg relative">
                  ...
                  <div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-700">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="relative group">
                          <select
                            className="w-full appearance-none border border-gray-200 dark:border-reply-border-dark rounded-xl px-4 py-3 text-sm bg-reply-bg dark:bg-reply-panel-dark text-gray-700 dark:text-gray-200 outline-none hover:border-indigo-300 dark:hover:border-indigo-700 transition-colors cursor-pointer"
                            onChange={(e) => {
                              if (e.target.value) {
                    ...
                    <div>
                      <button
                        ...
                        className="w-full aspect-[3/1] border-2 border-dashed border-gray-200 dark:border-reply-border-dark hover:border-indigo-500/50 hover:bg-indigo-50/50 dark:hover:bg-indigo-900/10 rounded-xl flex flex-col items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400 transition-all group"
                      >
                ...
                <div
                  className={`border-t border-gray-200 dark:border-reply-border-dark bg-[#1e1e1e] flex flex-col transition-all duration-500 ease-in-out ${showCodeEditor ? "flex-1" : "h-0 overflow-hidden"}`}
                >
                  ...
                  <div
                    className={`transition-all duration-300 overflow-hidden shadow-2xl relative ${
                      previewDevice === "mobile"
                        ...
                        : "w-full h-full max-w-4xl rounded-lg border border-gray-300 dark:border-reply-border-dark"
                    }`}
                  >
