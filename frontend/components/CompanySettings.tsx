...
export const CompanySettings: React.FC = () => {
  ...
  const AvatarPickerModal = () => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fadeIn">
        <div className="bg-white dark:bg-[#1f2937] rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="bg-white dark:bg-[#202c33] p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
              ...
              {googleCalendarConnected ? (
                ...
                <button
                  ...
                  className="bg-white border-2 border-gray-300 text-gray-700 px-4 py-2 rounded-lg font-semibold hover:bg-gray-50 transition-colors flex items-center gap-2"
                >
        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            <div className="bg-white dark:bg-[#202c33] p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* PROVIDER GUIDE TABS */}
                <div className="col-span-2 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                  <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex text-xs font-bold text-gray-500 overflow-x-auto">
                    <button
                      onClick={() => setHelpTab("gmail")}
                      className={`px-4 py-3 hover:text-indigo-600 transition-colors ${helpTab === "gmail" ? "bg-white dark:bg-[#202c33] text-indigo-600 border-b-2 border-indigo-600" : ""}`}
                    >
                      Gmail / G-Suite
                    </button>
                    <button
                      onClick={() => setHelpTab("outlook")}
                      className={`px-4 py-3 hover:text-blue-600 transition-colors ${helpTab === "outlook" ? "bg-white dark:bg-[#202c33] text-blue-600 border-b-2 border-blue-600" : ""}`}
                    >
                      Outlook / Office365
                    </button>
                    <button
                      onClick={() => setHelpTab("zoho")}
                      className={`px-4 py-3 hover:text-green-600 transition-colors ${helpTab === "zoho" ? "bg-white dark:bg-[#202c33] text-green-600 border-b-2 border-green-600" : ""}`}
                    >
                      Zoho Mail
                    </button>
                    <button
                      onClick={() => setHelpTab("cpanel")}
                      className={`px-4 py-3 hover:text-orange-600 transition-colors ${helpTab === "cpanel" ? "bg-white dark:bg-[#202c33] text-orange-600 border-b-2 border-orange-600" : ""}`}
                    >
                      cPanel / Otro
                    </button>
                  </div>
                ...
                <div className="col-span-2">
                  ...
                  <select
                    disabled
                    className="w-full border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-[#111b21] rounded-lg px-4 py-2 text-gray-500 cursor-not-allowed"
                ...
                <div className="col-span-2 flex items-center justify-between gap-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                  <div className="flex items-center gap-2">
                    <input
                      type="checkbox"
  ...
  return (
    <div className="h-full bg-gray-50 dark:bg-[#0b141a] flex flex-col transition-colors duration-200">
      <ModuleHeader
      ...
      <div className="flex-1 overflow-hidden flex flex-col md:flex-row">
        ...
        {/* Content Area */}
        {/* Content Area */}
        <div className="flex-1 flex flex-col min-w-0 bg-gray-50 dark:bg-[#0b141a]">
          <div className="flex-1 overflow-y-auto p-4 md:p-8 relative scroll-smooth">
            <div className="max-w-4xl mx-auto pb-10">
              ...
              {activeTab === "billing" && (
                <div className="space-y-6 animate-fadeIn">
                  {/* Plan Overview Card */}
                  <div className="bg-white dark:bg-[#202c33] p-8 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
                      ...
                      <div className="bg-gradient-to-r from-[#635BFF] to-[#635BFF]/80 p-5 rounded-xl text-white shadow-lg max-w-sm w-full">
                        ...
                        <button
                          className="w-full py-2 bg-white text-[#635BFF] rounded-lg font-bold text-sm hover:bg-gray-50 transition-colors shadow-sm cursor-not-allowed opacity-80"
                          disabled
                        >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {/* Included Features */}
                    <div className="bg-white dark:bg-[#202c33] p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm h-full">
                      <h4 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-6 flex items-center gap-2">
                        <svg
                          className="w-4 h-4"
                          fill="none"
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          <div
                            key={i}
                            className={`flex items-center justify-between p-3 rounded-lg border ${feature.enabled ? "bg-gray-50 dark:bg-gray-800/30 border-gray-100 dark:border-gray-700" : "bg-gray-50 opacity-50 border-transparent"}`}
                          >
                  ...
                  <div
                    id="payment-methods"
                    className="bg-gray-50 dark:bg-[#111b21] p-6 rounded-xl border border-gray-200 dark:border-gray-700 text-left"
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-white dark:bg-[#202c33] p-4 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm">
