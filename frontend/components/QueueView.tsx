...
export const QueueView: React.FC<QueueViewProps> = ({
  ...
  return (
    <div className="w-full bg-white dark:bg-[#111b21] border-r border-gray-200 dark:border-gray-700 flex flex-col h-full">
      {/* Header */}
      <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20">
              ...
              return (
                <div key={priority}>
                  <button
                    ...
                    className={`w-full px-4 py-2 text-left text-[10px] font-bold uppercase tracking-wider flex items-center justify-between ${config.color} bg-opacity-10 dark:bg-opacity-20 border-b border-gray-100 dark:border-gray-800 sticky top-0 z-10`}
