...
export const FlowPropertiesPanel: React.FC<FlowPropertiesPanelProps> = ({ node, onUpdate, onDelete }) => {
  ...
  const fetchAIAgents = async () => {
    ...
    try {
      ...
      setAiAgents(data.data?.agents || data.agents || []);
    } catch (error) {
  ...
  return (
    <div className="w-80 bg-white dark:bg-[#202c33] border-l border-gray-200 dark:border-gray-700 p-6 shadow-lg z-20 overflow-y-auto animate-slide-in-right h-full">
      <div className="flex justify-between items-center mb-6">
        <h3 className="font-bold text-gray-800 dark:text-white">Propiedades</h3>
        <button onClick={onDelete} className="text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 p-2 rounded-lg transition-colors" title="Eliminar Nodo">
      ...
      <div className="space-y-4">
        {/* COMMON: Label */}
        <div>
          <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Etiqueta Interna</label>
          <input 
            type="text" 
            value={node.data.label} 
            onChange={e => onUpdate('label', e.target.value)}
            className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500 outline-none"
          />
        </div>
        ...
        {node.type === 'message' && (
          <div>
            <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Contenido del Mensaje</label>
            <textarea 
              rows={4}
            ...
            />
            <p className="text-xs text-gray-400 mt-1">Puedes usar variables como {'{{nombre}}'}.</p>
          </div>
        )}
        ...
        {node.type === 'input' && (
          <>
            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Pregunta al Usuario</label>
              <textarea 
                rows={2}
                value={node.data.content || ''} 
                onChange={e => onUpdate('content', e.target.value)}
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Guardar en Variable</label>
              <input 
                type="text" 
                placeholder="ej: email_cliente"
                value={node.data.variableName || ''} 
                onChange={e => onUpdate('variableName', e.target.value)}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm font-mono focus:ring-2 focus:ring-indigo-500 outline-none"
              />
            </div>
          </>
        )}
          ...
          <>
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-200 dark:border-blue-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-xs font-bold text-blue-900 dark:text-blue-300">Enviar Imagen</p>
              </div>
            ...
            <div>
              ...
              <input 
                ...
                value={node.data.mediaUrl || node.data.imageUrl || ''} 
                onChange={e => {
                  onUpdate('mediaUrl', e.target.value);
                  onUpdate('imageUrl', e.target.value);
                }}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-blue-500 outline-none"
              />
              <button
                onClick={() => {
          ...
          <>
            <div className="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg border border-purple-200 dark:border-purple-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-xs font-bold text-purple-900 dark:text-purple-300">Enviar Video</p>
              </div>
            ...
            <div>
              ...
              <input 
                ...
                value={node.data.mediaUrl || node.data.videoUrl || ''} 
                onChange={e => {
                  onUpdate('mediaUrl', e.target.value);
                  onUpdate('videoUrl', e.target.value);
                }}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-purple-500 outline-none"
              />
              <button
                onClick={() => {
        ...
        {node.type === 'send_audio' && (
          <>
            <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-200 dark:border-green-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">🎵</span>
                <p className="text-xs font-bold text-green-900 dark:text-green-300">Enviar Audio</p>
              </div>
            ...
            <div>
              ...
              <input 
                ...
                value={node.data.mediaUrl || node.data.audioUrl || ''} 
                onChange={e => {
                    onUpdate('mediaUrl', e.target.value);
                    onUpdate('audioUrl', e.target.value);
                }}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-green-500 outline-none"
              />
              <button
                onClick={() => {
        ...
        {node.type === 'send_document' && (
          <>
            <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg border border-gray-200 dark:border-gray-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">📄</span>
                <p className="text-xs font-bold text-gray-900 dark:text-gray-300">Enviar Documento</p>
              </div>
            ...
            <div>
              ...
              <input 
                ...
                value={node.data.mediaUrl || node.data.documentUrl || ''} 
                onChange={e => {
                    onUpdate('mediaUrl', e.target.value);
                    onUpdate('documentUrl', e.target.value);
                }}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-gray-500 outline-none"
              />
              <button
                onClick={() => {
        ...
        {node.type === 'send_message' && (
          <>
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-200 dark:border-blue-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">💬</span>
                <p className="text-xs font-bold text-blue-900 dark:text-blue-300">Enviar Mensaje de Texto</p>
              </div>
            </div>
        ...
        {node.type === 'ask_data' && (
          <>
            <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg border border-orange-200 dark:border-orange-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">✍️</span>
                <p className="text-xs font-bold text-orange-900 dark:text-orange-300">Solicitar Datos</p>
              </div>
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-orange-500 outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input 
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm font-mono focus:ring-2 focus:ring-orange-500 outline-none"
              />
              <p className="text-xs text-gray-400 mt-1">
          ...
          <>
            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 p-4 rounded-lg border border-cyan-200 dark:border-cyan-800 mb-4">
              ...
              <p className="text-xs text-cyan-700 dark:text-cyan-400">
                Selecciona un agente existente de "IA & Conocimiento" o crea uno nuevo.
              </p>
            </div>
            ...
            <div>
              ...
              {loadingAgents ? (
                <div className="w-full p-3 bg-gray-50 dark:bg-gray-800 rounded-lg text-center">
                  <div className="animate-spin inline-block w-5 h-5 border-2 border-cyan-500 border-t-transparent rounded-full"></div>
                  <p className="text-xs text-gray-500 mt-2">Cargando agentes...</p>
                </div>
              ) : (
                <>
                  <select
                    ...
                    className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-cyan-500 outline-none"
                  >
                  ...
                  {fetchError && (
                    <div className="mt-2 p-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded text-center">
                        <p className="text-xs text-red-600 dark:text-red-400 mb-1">Error al cargar agentes</p>
                        <button 
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                      {selectedAgent.model || 'GPT-3.5 Turbo'}
                    </p>
                  </div>
        ...
        {node.type === 'ai_handoff' && (
          <>
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Mensaje de Transferencia</label>
              <textarea 
                rows={3}
                value={node.data.content || 'Te estoy conectando con un agente humano...'} 
                onChange={e => onUpdate('content', e.target.value)}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-orange-500 outline-none"
              />
            </div>
        ...
        {node.type === 'condition' && (
          <>
            <div className="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-lg border border-yellow-200 dark:border-yellow-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">❓</span>
                <p className="text-xs font-bold text-yellow-900 dark:text-yellow-300">Condición / Ramificación</p>
              </div>
            ...
            <div>
              ...
              <input 
                ...
                value={node.data.variable || node.data.variableName || ''} 
                onChange={e => onUpdate('variable', e.target.value)}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm font-mono focus:ring-2 focus:ring-yellow-500 outline-none"
              />
              <p className="text-xs text-gray-400 mt-1">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-yellow-500 outline-none"
              >
            ...
            <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <p className="text-xs text-blue-800 dark:text-blue-300">
                💡 <strong>Cómo funciona:</strong> Conecta diferentes nodos a este nodo de condición. 
                Si la condición es verdadera, seguirá un camino. Si es falsa, seguirá otro.
              </p>
            </div>
          </>
        )}
        ...
        {node.type === 'create_deal' && (
          <>
            <div className="bg-emerald-50 dark:bg-emerald-900/20 p-3 rounded-lg border border-emerald-200 dark:border-emerald-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">💰</span>
                <p className="text-xs font-bold text-emerald-900 dark:text-emerald-300">Crear Deal</p>
              </div>
            ...
            <div>
              ...
              <input 
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-emerald-500 outline-none"
              />
              <p className="text-xs text-gray-400 mt-1">
            ...
            <div>
              ...
              <input 
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm font-mono focus:ring-2 focus:ring-emerald-500 outline-none"
              />
              <p className="text-xs text-gray-400 mt-1">
        ...
        {node.type === 'update_contact' && (
          <>
            <div className="bg-indigo-50 dark:bg-indigo-900/20 p-3 rounded-lg border border-indigo-200 dark:border-indigo-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">👤</span>
                <p className="text-xs font-bold text-indigo-900 dark:text-indigo-300">Actualizar Contacto</p>
              </div>
        ...
        {node.type === 'assign_agent' && (
          <>
            <div className="bg-pink-50 dark:bg-pink-900/20 p-3 rounded-lg border border-pink-200 dark:border-pink-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">🎯</span>
                <p className="text-xs font-bold text-pink-900 dark:text-pink-300">Asignar Agente Específico</p>
              </div>
              <p className="text-xs text-pink-700 dark:text-pink-400">
                Asigna la conversación a un agente humano específico
              </p>
            </div>
            ...
            <div>
              ...
              <input 
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm font-mono focus:ring-2 focus:ring-pink-500 outline-none"
              />
              <p className="text-xs text-gray-400 mt-1">
                Puedes encontrar el ID en la lista de usuarios del CRM
              </p>
            </div>
            ...
            <div>
              ...
              <textarea 
                rows={2}
                placeholder="Te estoy conectando con {{agente}}..."
                value={node.data.message || ''} 
                onChange={e => onUpdate('message', e.target.value)}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-pink-500 outline-none"
              />
            </div>

            <div className="p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
              <p className="text-xs text-orange-800 dark:text-orange-300">
                ⚠️ El bot se detendrá después de asignar el agente
              </p>
            </div>
          </>
        )}
        ...
        {node.type === 'delay' && (
          <>
            <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded-lg border border-orange-200 dark:border-orange-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">⏱️</span>
                <p className="text-xs font-bold text-orange-900 dark:text-orange-300">Delay / Espera</p>
              </div>
              <p className="text-xs text-orange-700 dark:text-orange-400">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input 
                  ...
                  className="flex-1 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-orange-500 outline-none"
                />
                <select
                  value={node.data.delayUnit || 'minutes'}
                  onChange={e => onUpdate('delayUnit', e.target.value)}
                  className="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-orange-500 outline-none"
                >
            ...
            <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <p className="text-xs text-blue-800 dark:text-blue-300">
                💡 El flujo continuará automáticamente después del tiempo especificado
              </p>
            </div>
          </>
        )}
        ...
        {node.type === 'end' && (
          <>
            <div className="bg-gray-50 dark:bg-gray-900/20 p-3 rounded-lg border border-gray-200 dark:border-gray-800 mb-3">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-xl">🏁</span>
                <p className="text-xs font-bold text-gray-900 dark:text-gray-300">Fin del Flujo</p>
              </div>
              <p className="text-xs text-gray-700 dark:text-gray-400">
        ...
        {node.type === 'action_email' && (
          <>
            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Destinatario</label>
              <input 
                type="text" 
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Asunto</label>
              <input 
                type="text" 
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Cuerpo del Correo</label>
              <textarea 
                rows={4}
                value={node.data.content || ''} 
                onChange={e => onUpdate('content', e.target.value)}
        ...
        {node.type === 'action_calendar' && (
          <>
            <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg border border-red-200 dark:border-red-800 mb-4">
               <div className="flex items-center gap-2 mb-1">
                 <svg className="w-5 h-5 text-red-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9v-2h2v2zm0-4H9V7h2v5z" /></svg>
                 <p className="text-xs font-bold text-red-800 dark:text-red-300">Integración Google Calendar</p>
               </div>
               <p className="text-xs text-red-600 dark:text-red-300">
                 Este nodo enviará opciones de horario disponibles o un link de agendamiento al usuario.
               </p>
            </div>
            ...
            <div>
              ...
              <input 
                ...
                value={node.data.label || ''} 
                onChange={e => onUpdate('label', e.target.value)}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-red-500 outline-none"
              />
            </div>

            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Duración (minutos)</label>
              <select 
             ...
             <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Link de Calendario (Opcional)</label>
              <input 
                type="text" 
                ...
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-[#111b21] text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-red-500 outline-none"
              />
              <p className="text-[10px] text-gray-400 mt-1">Si se deja vacío, se usará la integración nativa de Google Calendar.</p>
            </div>

            <div>
               <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Mensaje de Éxito</label>
               <textarea 
                rows={2}
        ...
        {node.type === 'action_task' && (
          <>
            <div>
              <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-1">Título de la Tarea</label>
              <input 
                type="text" 
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700 mt-auto">
           ...
           <p className="text-xs text-gray-400">Tipo: {node.type.toUpperCase()}</p>
        </div>
      </div>
