...
export const ResolvedView: React.FC<ResolvedViewProps> = ({
    ...
    return (
      ...
      >
        ...
        <div className="relative flex-shrink-0">
          ...
          {isFastResolution && (
            <div className="absolute -bottom-1 -right-1 bg-yellow-400 rounded-full p-0.5 border-2 border-white dark:border-gray-800">
  ...
  return (
    <div className="w-full bg-white dark:bg-[#111b21] border-r border-gray-200 dark:border-gray-700 flex flex-col h-full">
      {/* Header */}
      ...
      <div className="px-3 py-2 border-b border-gray-100 dark:border-gray-800">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-xs bg-gray-100 dark:bg-[#202c33] border-0 rounded-lg focus:ring-2 focus:ring-green-500 dark:text-white placeholder-gray-400"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin">
        {Object.entries(groupedByDate).map(([dateLabel, ticketGroup]) => (
          <div key={dateLabel}>
            <div className="px-4 py-2 text-[10px] font-bold text-gray-400 uppercase tracking-wider bg-gray-50/80 dark:bg-[#111b21]/80 backdrop-blur sticky top-0 z-10 border-b border-gray-100 dark:border-gray-800 flex items-center gap-2">
