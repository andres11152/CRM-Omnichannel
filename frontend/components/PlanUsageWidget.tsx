...
export const PlanUsageWidget: React.FC<Props> = ({ planName, usage }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-[#202c33] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden relative">
      {/* Header */}
      <div className="p-5 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-[#111b21]/50 flex justify-between items-center">
         <div>
      ...
      {/* Footer Up-sell */}
      <div className="p-4 bg-gradient-to-r from-gray-50 to-white dark:from-[#1a262d] dark:to-[#202c33] border-t border-gray-100 dark:border-gray-800 text-center">
