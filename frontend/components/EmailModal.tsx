  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4 animate-fade-in">
      ...
      <div className="bg-white dark:bg-[#202c33] rounded-2xl shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh] overflow-hidden border border-gray-200 dark:border-gray-700">
        {/* Header - Fixed at top */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex-shrink-0 bg-gray-50/50 dark:bg-[#2a3942]/50">
        ...
        <div className="p-6 space-y-5 overflow-y-auto custom-scrollbar flex-1">
          ...
          <div className="group">
            ...
            <div className="relative">
              ...
              <input
                ...
                value={from}
                disabled
                className="w-full pl-9 pr-4 py-2.5 bg-gray-50 dark:bg-[#111b21] border border-gray-200 dark:border-gray-700 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 shadow-sm opacity-80 cursor-not-allowed select-none"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 bg-white dark:bg-[#2a3942] border border-gray-300 dark:border-gray-600 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm"
              />
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-white dark:bg-[#2a3942] border border-gray-300 dark:border-gray-600 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm font-medium"
            />
          </div>
          ...
          <div className="flex-1 min-h-[150px]">
            ...
            <textarea
              ...
              className="w-full h-full min-h-[200px] px-4 py-3 bg-white dark:bg-[#2a3942] border border-gray-300 dark:border-gray-600 rounded-xl text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-inner resize-y leading-relaxed"
            />
          </div>
        </div>

        {/* Footer - Fixed at bottom */}
        <div className="flex items-center justify-end gap-3 p-4 px-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-[#2a3942]/50 flex-shrink-0">
          <button
            onClick={onClose}
