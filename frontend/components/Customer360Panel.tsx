      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar bg-gray-50/30 dark:bg-[#111b21]">
        ...
        <div className="p-6 text-center border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-[#111b21]">
          <div className="relative inline-block group">
            ...
            />
            <div
              className={`absolute bottom-1 right-1 w-6 h-6 ${isGroup ? "bg-green-500" : "bg-white dark:bg-[#1f2937]"} p-1 rounded-full shadow-lg flex items-center justify-center border border-gray-100 dark:border-gray-700`}
            >
              {isGroup ? (
