...
export const TeamManager: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50 dark:bg-[#0b141a] transition-colors duration-200 font-sans">
      ...
      {/* Navigation Tabs */}
      <div className="px-4 md:px-8 pt-4 bg-gray-50 dark:bg-[#0b141a] z-10 shrink-0">
        <div className="flex gap-1 md:gap-2 border-b border-gray-200 dark:border-gray-700 overflow-x-auto no-scrollbar">
          <button
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden min-h-0 bg-gray-50 dark:bg-[#0b141a]">
        {activeView === "permissions" ? (
          <div className="p-0">
            <PermissionsPanel />
          </div>
