...
export const BillingOpsPage = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-50 dark:bg-[#0b141a]">
      <ModuleHeader
      ...
      <div className="flex-1 overflow-hidden p-6 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 flex-none">
          <div className="bg-white dark:bg-[#1f2c34] p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 flex items-center gap-4">
        ...
        {/* Transactions Table */}
        <div className="flex-1 bg-white dark:bg-[#1f2c34] rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-auto custom-scrollbar">
            <table className="w-full text-left border-collapse">
              <thead className="bg-slate-50 dark:bg-slate-800/50 sticky top-0 z-10 backdrop-blur-sm">
                <tr className="text-xs font-semibold text-slate-500 dark:text-slate-400 border-b border-slate-200 dark:border-slate-800">
