      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 relative scroll-smooth">
        <div className="max-w-4xl mx-auto pb-10">
          <div className="space-y-6 animate-fadeIn">
            {/* Profile Card */}
            <div className="bg-white dark:bg-[#202c33] p-8 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                  <div className="col-span-2 md:col-span-1">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-[#111b21] rounded-lg px-4 py-2.5 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        disabled
                        className="w-full border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-[#111b21]/50 rounded-lg px-4 py-2.5 text-gray-500 cursor-not-allowed pl-10"
                      />
                      <svg
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-[#111b21] rounded-lg px-4 py-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all resize-none"
