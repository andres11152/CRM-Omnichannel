...
export const MediaLibrary: React.FC<MediaLibraryProps> = ({
  ...
  return (
    <div
      className="h-full flex flex-col bg-gray-50 dark:bg-[#0b141a] font-sans"
    ...
    >
      {/* Header */}
      {onClose ? (
        <div className="bg-white dark:bg-[#202c33] px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center shadow-sm z-10">
      ...
      {/* Toolbar */}
      <div className="px-6 py-4 bg-white dark:bg-[#202c33] border-b border-gray-200 dark:border-gray-700 flex flex-col md:flex-row gap-4 justify-between items-center sticky top-0 z-10 shadow-sm">
        ...
        <div className="flex w-full md:w-auto gap-3">
          <div className="relative flex-1 md:w-64">
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-800 border-none rounded-xl text-gray-800 dark:text-white focus:ring-2 focus:ring-purple-500/50"
            />
            <svg
      ...
      <div className="flex-1 overflow-y-auto p-6 scroll-smooth">
        {loading ? (
          ...
          <div className="h-full flex flex-col items-center justify-center text-gray-400 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-3xl m-4 bg-gray-50/50 dark:bg-gray-800/30">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
            {media.map((item) => (
              <div
                ...
                className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden ring-1 ring-gray-100 dark:ring-gray-700 hover:ring-purple-500 hover:-translate-y-1"
              >
              ...
              <div className="flex gap-4 text-sm text-gray-400">
                <span>
                  ...
                  <span className="text-white">
                    {selectedMedia.uploadedBy.name || "Desconocido"}
                  </span>
                </span>
              </div>
              <button
      ...
      {mediaToDelete && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-[#1f2937] rounded-2xl shadow-2xl w-full max-w-md border border-gray-100 dark:border-gray-700 overflow-hidden transform transition-all scale-100">
