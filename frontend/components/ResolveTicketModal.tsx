...
export const ResolveTicketModal: React.FC<Props> = ({
  ...
  return (
    <div className="fixed inset-0 z-[5000] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      ...
      <div className="bg-white dark:bg-[#1f2937] rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden border border-gray-100 dark:border-gray-700">
        {/* 1. Header (Sticky) */}
        <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-white dark:bg-[#1f2937] flex-shrink-0 z-10">
          ...
          >
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full px-4 py-3 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[100px] resize-none transition-all placeholder:text-gray-400"
              />
        ...
        {/* 3. Footer (Sticky) */}
        <div className="p-4 border-t border-gray-100 dark:border-gray-700 bg-white dark:bg-[#1f2937] flex-shrink-0 flex gap-3 z-10">
          <button
