...
export const SchemaVisualizer: React.FC = () => {
  return (
    <div className="p-6 bg-white dark:bg-[#202c33] rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 transition-colors duration-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {DB_SCHEMA.map((table) => (
          <div key={table.tableName} className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-gray-50 dark:bg-[#111b21] flex flex-col transition-colors duration-200">
            <div className="bg-gray-100 dark:bg-[#2a3942] px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            ...
            <div className="p-4 flex-1">
              ...
              <ul className="space-y-2">
                {table.columns.map((col) => (
                  <li key={col.name} className="flex justify-between items-start text-sm border-b border-gray-200 dark:border-gray-700 last:border-0 pb-2 last:pb-0">
